...
public class NotaRepositoryXML extends AbstractRepositoryXML<Pair<String, String>, Nota> {
    /**
    ...
    public Element createElementfromEntity(Document document, Nota entity) {
        ...
        e.setAttribute("idStudent", entity.getID().getKey());
        e.setAttribute("idTema", entity.getID().getValue());
        ...
        notaProf.setTextContent(entity.getNotaProf());
