...
class ValidatorStudentTest {
    ...
    Student s1=new Student("9999","Enachioiu","Teofana","223","teoffa@yahoo.com","Adriana Guran");
    Student s2=new Student("0","Enachioiu","Teofana","223","teoffa@yahoo.com","Adriana Guran");
    Student s3=new Student("9999","Enachioiu"," T30F4N4","223","teoffa@yahoo.com","Adriana Guran");
    Student s4=new Student("9999","Enachioiu","Teofana","203","teoffa@yahoo.com","Adriana Guran");
